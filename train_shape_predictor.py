...
ap.add_argument("--dataset", required=True, help="Training dataset path")
ap.add_argument("--output", required=True, help="Output model")
...
custom_train_path = args['dataset']

model_saved_path = args['output']
...
dlib.train_shape_predictor(custom_train_path, model_saved_path, options)

print("[INFO] Traning is done...\n" + "Please check " + model_saved_path)